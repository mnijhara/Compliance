      ...
      <section className="border-b border-slate-200 bg-gradient-to-b from-indigo-50/50 via-white to-white px-4 pb-20 pt-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <div className="mx-auto max-w-4xl text-center">
            <div className="inline-flex items-center gap-2 rounded-full border border-indigo-200 bg-indigo-50 px-3.5 py-1.5 text-xs font-semibold text-indigo-700"><ShieldCheck className="h-3.5 w-3.5" /> ComplyOS · AI-native HR compliance</div>
            <h1 className="mt-6 text-4xl font-extrabold leading-tight tracking-tight sm:text-6xl">The AI-native <span className="bg-gradient-to-r from-indigo-600 to-blue-600 bg-clip-text text-transparent">HR Compliance Operating System</span>.</h1>
            <p className="mx-auto mt-6 max-w-3xl text-lg leading-relaxed text-slate-600">ComplyOS combines deterministic compliance controls, authoritative source mapping, evidence management and AI-assisted review for CHRO and HR compliance teams.</p>
            ...
            <div className="mx-auto mt-10 max-w-3xl rounded-2xl border border-amber-200 bg-amber-50 p-4 text-left text-xs text-amber-950"><strong>ComplyOS evidence principle:</strong> missing evidence produces REVIEW, not PASS. AI-generated legal propositions remain unverified until mapped to an authoritative source.</div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-slate-50 px-4 py-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <div className="grid grid-cols-1 gap-10 lg:grid-cols-2 lg:items-center">
            <div><div className="text-xs font-bold uppercase tracking-widest text-indigo-700">How ComplyOS works</div><h2 className="mt-3 text-3xl font-extrabold">Source → Rule → Evidence → Decision</h2><p className="mt-4 text-sm leading-relaxed text-slate-600">The compliance record is built from an auditable chain instead of an opaque model response.</p></div>
