...
/**
 * State profiles deliberately describe the evidence and authoritative sources
 * that must be collected. They do not encode unsupported state-law conclusions.
 */
export const JURISDICTION_PROFILES: JurisdictionProfile[] = [
  {
    ...
    authoritativeSourceIds: ['mole-labour-handbook-2026', 'mole-labour-codes-effective', 'mole-annual-report-2024-25'],
  ...
  },
  {
    ...
    authoritativeSourceIds: ['delhi-labour-department', 'delhi-shops-establishments-act', 'mole-labour-codes-effective'],
    verificationPolicy: 'A Delhi-specific conclusion requires a current primary Delhi source mapped to the control and verification date. A source registry match alone is not a legal conclusion.',
  ...
  },
  {
    ...
    authoritativeSourceIds: ['karnataka-labour-district-department', 'karnataka-labour-welfare-board', 'mole-labour-codes-effective'],
    verificationPolicy: 'A Karnataka-specific conclusion requires a current primary Karnataka source mapped to the control and verification date. Draft or background material must never be treated as an operative rule.',
    applicabilityInputs: ['employeeCount', 'establishmentType', 'industry', 'workplaceLocation', 'contractWorkers', 'nightShift']
  },
  {
    ...
    authoritativeSourceIds: ['maharashtra-labour-commissioner', 'mole-labour-codes-effective'],
    verificationPolicy: 'A Maharashtra-specific conclusion requires a current primary Maharashtra source mapped to the control and verification date. The department portal is a discovery and verification layer, not a substitute for the operative notification.',
    applicabilityInputs: ['employeeCount', 'establishmentType', 'industry', 'workplaceLocation', 'contractWorkers', 'nightShift']
  }
];
